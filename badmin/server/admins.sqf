...
if (loadFile (externalConfigFolder + "\admins.sqf") != "") then
{
	...
	diag_log "[A3BG_LOG] bAdmin - External admins.sqf loaded";
}
else
{
	...
	********************************************************/
	...
	/********************************************************/
	diag_log "[A3BG_LOG] bAdmin - ERROR! \bAdmin_settings\admins.sqf not found!";
	diag_log "[A3BG_LOG] bAdmin - This folder must be in the server directory";
};
