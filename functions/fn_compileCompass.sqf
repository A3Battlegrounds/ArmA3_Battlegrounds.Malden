 ...
 *
 *	@file Name: fn_compileCompass.sqf
...
_compassNeedle ctrlSetStructuredText parseText format["<t shadow=2><t shadowColor='#ff0000' align='center' size='%1' color='#f90000'>|</t>", 0.65];
