...
_nc_settings = [0.499889,0.0346965,3.16098,1.86439,0,1.18143,"C0",0.753254,"RobotoCondensedBold",0,1,1,-0.0340903,5,1,0,"B1B1","FFFFFF"];
...
_comp = [ncType, ncInvert, ncFontSize, ncShadow, ncFontOption, ncAlpha, ncColorOption] call A3BG_fnc_compileCompass;
