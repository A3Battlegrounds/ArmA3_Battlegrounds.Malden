 ...
 *
 *	@file Name: fn_outofareatext.sqf
...
_messageoutofareatext = _this select 0;

[_messageoutofareatext, [safezoneX + 0.39 * safezoneW, 0.8], [safezoneY + 0.125 * safezoneH, 1], 2, 0, 0, 7013] spawn BIS_fnc_dynamicText;
