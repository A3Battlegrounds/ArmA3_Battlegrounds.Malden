 ...
 *
 *	@file Name: fn_messagecentertext.sqf
...
_messagecentertext = _this select 0;

[_messagecentertext, [safezoneX + 0.4 * safezoneW, 0.5], [safezoneY + 0.7 * safezoneH, 1], 7, 0, 0, 7011] spawn BIS_fnc_dynamicText;